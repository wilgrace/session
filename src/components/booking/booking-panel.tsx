      ...
      <CardContent className="p-6 space-y-6">
        ...
        <div className="bg-muted/30 rounded-xl p-4 space-y-3">
          ...
          <div className="flex justify-between pt-3 border-t border-muted">
            ...
            <span className="text-xl font-bold text-primary">{formatPrice(originalTotal)}</span>
          </div>
        </div>
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button
                type="button"
                variant="outline"
                className="w-full h-12 rounded-xl text-destructive hover:text-destructive hover:bg-destructive/10 border-destructive/30"
                disabled={loading}
              >
                Cancel Booking
              </Button>
